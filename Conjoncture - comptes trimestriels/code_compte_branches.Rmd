---
title: "Comptes de branche. Résultats détaillés des grands indicateurs macroéconomique des Comptes Nationaux Trimestriels. "
author: "@statjunior"
...
setwd <- setwd("C:/Users/Documents/GitHub/Statjunior/projets-r-statjunior/cnt/")
getwd()
...
Ce rapport *RMarkdown* présente les résultats détaillés des comptes de branche. Il présente les grands agrégats économiques de la production (PIB) et des revenus de la nation (Excédent Brut d'exploitation, Salaire Moyen par Tête). 

Dans un premier temps, on s'intéresse à la croissance trimestrielle du PIB. On constate les contributions à l'évolution du PIB par grande fonction (Consommation, Investissement, Solde extérieur, Variations de stocks). On compare le PIB en variation trimestrielle et en évolution depuis la Crise du Covid. 

On présente également l'évolution du solde extérieur de la France (exports - imports). 

Un focus est présenté sur l'évolution de la consommation des ménages depuis le Covid, en particulier pour la consommation alimentaire et énergétique. 
...
## Glissement des déflateurs des composantes du PIB au dernier trimestre connu 
```{r,fig.dim = c(14, 9)}
...
plot_prod_travail_2000 <-ggplot(data = prod_travail_2000,
  ...
  labs(title = "Valeur ajoutée et productivité horaire du travail sur longue période", 
       subtitle = "Lecture : Au 1er trimestre 2023, la productivité du travail recule de X points par rapport à la fin 2019. \nSource : Insee (Comptes nationaux Trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphiques : @statjunior", 
...
## Evolution de la producitivté du travail et du Salaire Moyen par Tête (SMPT) depuis 2000
```{r,fig.dim = c(14, 9)}
...
plot_prod_travail_tete_2019 <-ggplot(data = prod_travail_2019,
  ...
  labs(title = "Productivité horaire et par tête du travail depuis la crise du Covid", 
       subtitle = "Lecture : Au 1er trimestre 2023, la productivité horaire du travail recule de 3,3 % par rapport au 4e trimestre 2019. \nSource : Insee (Comptes nationaux Trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphique : @statjunior", 
       y = "Base 100 au 4e trimestre 2019", x = "Année") +
  scale_x_date(limits = as.Date(c("2000-01-01", date_max_compte_def))) + 
...
scale_masse_salariale17 <- function(x, na.rm = FALSE) x/x[masse_salariale[,1] == "2000-01-01"]*100
...
plot_vol_travail_prod <-ggplot(data = masse_salariale,
  ...
  labs(title = "Décomposition de la valeur ajoutée entre productivité horaire et volume global de travail depuis 1990", 
       subtitle = "Lecture : Au 1er trimestre 2023, la valeur ajoutée augmente de 1,3 % par rapport au 4e trimestre 2019. Le volume global de travail augmente de 4,5 %, la productivité du travail recule de 3,2 %. \nChamp : Secteurs marchands non agricoles \nSource : Insee (Comptes nationaux trimestriels, dernier point : T4-2022) \nCalculs et graphiques : @statjunior", 
...
plot_smpt_productivite <-ggplot(data = masse_salariale,
  ...
  labs(title = "Evolution de la productivité du travail et du pouvoir d'achat du Salaire Moyen par Tête", 
       subtitle = "Lecture : Au 1er trimestre 2023, le pouvoir d'achat du salaire moyen par tête recule de 4,4 % (et la productivité par tête de 5,6 %) par rapport au 4e trimestre 2019. \nChamp : Secteurs marchands non agricoles \nSource : Insee (Comptes nationaux trimestriels, dernier point : T4-2022) \nCalculs et graphiques : @statjunior", 
...
plot_va_sectorielle_2019t4 <-ggplot(data = full_va_2019,
  ...
  labs(title = "Evolution de la Valeur Ajoutée par secteur depuis la crise du Covid", 
       subtitle = "Lecture : Au 1er trimestre 2023, la valeur ajoutée des secteurs marchands non agricoles progresse de 1,3 % par rapport au T4-2019. \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior", 
       y = "Variation par rapport au T4-2019 (%)", x = "Secteur") +
  #scale_color_manual(name = "Composante", values=c("red","grey50","grey50","grey50","grey50","grey50")) +
  theme_grey()+
  theme(legend.position="bottom",
...
plot_prod_travail_sectorielle_2019t4 <-ggplot(data = full_prod_travail_2019,
  ...
  labs(title = "Evolution de la Productivité horaire du travail par secteur depuis la crise du Covid", 
       subtitle = "Lecture : Au 1er trimestre 2023, la productivité horaire du travail des secteurs marchands non agricoles recule de 5,4 % par rapport au T4-2019. \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior", 
       y = "Variation par rapport au T4-2019 (%)", x = "Secteur") +
  #scale_color_manual(name = "Composante", values=c("red","grey50","grey50","grey50","grey50","grey50")) +
  theme_grey()+
  theme(legend.position="bottom",
...
plot_va_prod_heures_2019t4 <-ggplot(data = full_va_prod_2019,
  ...
  labs(title = "Evolution de la Productivité horaire du travail par secteur depuis la crise du Covid", 
       subtitle = "Lecture : Au 1er trimestre 2023, la productivité horaire du travail des secteurs marchands non agricoles recule de 4,1 % par rapport au 4e trimestre 2019. \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior", 
       y = "Variation par rapport au T4-2019 (%)", x = "Secteur") +
  #scale_color_manual(name = "Composante", values=c("red","grey50","grey50","grey50","grey50","grey50")) +
  theme_grey()+
...
plot_tx_marge_snf <- ggplot(data=decompo_tm_snf, aes(x=DATE, y=tx_marge)) +
  ...
  labs(title = "Taux de marge des sociétés non financières",
       subtitle = "Lecture : Au 1er trimestre 2023, le taux de marge des sociétés non financières est de 32,3 %. \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior",
...
plot_decompo_tm_snf_2018 <-ggplot(data = decompo_tm_snf_2018t4,
  ...
  labs(title = "Décomposition de la variation du taux de marge des sociétés non financières depuis la fin 2018", 
       subtitle = "Lecture : Depuis fin 2018, la baisse du taux de cotisation employeur contribue pour 2,1 points à la hausse du taux de marge des SNF (+0,5 point). \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior", 
...
full_tx_marge_2018t4 <-  filter(full_tx_marge_2018t4,DATE ==max(DATE)) |>
...
plot_tx_marge_sectorielle_2018 <-ggplot(data = full_tx_marge_2018t4,
  ...
  labs(title = "Variation du taux de marges par branche (par rapport à l'année 2018)", 
       subtitle = "Lecture : Au 1er trimestre 2023, le taux de marge du secteur marchand non agricole est supérieur de 0,2 point par rapport à la moyenne de l'année 2018. \nSource : Insee (Comptes trimestriels - Résultats détaillés T1 2023) \nCalculs et graphiques : @statjunior", 
...
graph_tx_marge_energie_alim <- ggplot(subset(ebe_superprofits, DATE >= as.Date('2000-01-01')), aes(x = DATE)) +
  ...
  labs(title = "Taux de marge des secteurs énergétiques et des services de transport", 
       subtitle = "Lecture : Au 1er trimestre 2023, le taux de marge de l'industrie énergétique, eau et déchets est de 71 %. \nSource : Insee (Comptes trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphiques : @statjunior", 
...
graph_tx_marge_cock <- ggplot(subset(ebe_superprofits, DATE >= as.Date('2000-01-01')), aes(x = DATE)) +
  ...
  labs(title = "Taux de marge des secteurs énergétiques", 
       subtitle = "Lecture : Au 1er trimestre 2023, le taux de marge de l'industrie de cockéfaction-raffinage est de 89 %. \nSource : Insee (Comptes trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphiques : @statjunior", 
       y = "Taux de marge (en %)", x = "Année")  +
...
graph_tx_marge_energie_alim_hors_cock <- ggplot(subset(ebe_superprofits, DATE >= as.Date('2000-01-01')), aes(x = DATE)) +
  ...
  labs(title = "Taux de marge de l'industrie agro-alimentaire", 
       subtitle = "Lecture : Au 1er trimestre 2023, le taux de marge de l'industrie agro-alimentaire est de 48 %. \nSource : Insee (Comptes trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphiques : @statjunior", 
       y = "Taux de marge (en %)", x = "Année")  +
...
graph_superprofits_energie <- ggplot(subset(ebe_superprofits, DATE >= as.Date('1970-01-01')), aes(x = DATE)) +
  ...
  labs(title = "Excédent Brut d'Exploitation des secteurs énergétiques, de raffinerie et des services de transport", 
       subtitle = "Lecture : Au 1er trimestre 2023, l'excédent brut d'exploitation des secteurs énergétiques, raffinerie et service de transport représente 5,8 % de la valeur ajoutée totale française. \nSource : Insee (Comptes trimestriels - Dernier point : 1er trimestre 2023) \nCalculs et graphiques : @statjunior", 
