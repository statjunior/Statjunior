...
subtitle: "Résultats détaillés de l’Enquête Emploi de l’Insee au 4e trimestre 2023"
author: "@statjunior"
...
plot_chom_bit_duree <-  ggplot(data=p_chom_bit, aes(x=DATE, y= OBS_VALUE)) +
  ...
  facet_wrap(vars(TITLE_FR1), scales = "free",ncol = 2)+
