...
setwd <- setwd("C:/Users/gasto/Documents/GitHub/Statjunior/Marché du travail et chômage/Chômage BIT, halo et sous emploi - Enquête Emploi/")
...
plot_chom_bit_duree2 <- ggplotly(plot_chom_bit_duree, height = 600, width = 1000)
plot_chom_bit_duree2 <-layout(plot_chom_bit_duree2, legend = list(orientation = "h", y = -0.2))
plot_chom_bit_duree2
```
...
plot_chom_bit_age2 <- ggplotly(plot_chom_bit_age, height = 600, width = 1000)
plot_chom_bit_age2 <-layout(plot_chom_bit_age2, legend = list(orientation = "h", y = -0.2))
plot_chom_bit_age2
```
...
plot_chom_elargi2 <- ggplotly(plot_chom_elargi, height = 600, width = 1000)
plot_chom_elargi2 <-layout(plot_chom_elargi2, legend = list(orientation = "h", y = -0.2))
...
plot_alo_age2 <- ggplotly(plot_alo_age, height = 600, width = 1000)
plot_alo_age2 <-layout(plot_alo_age2, legend = list(orientation = "h", y = -0.2))
...
plot_personnes_chomage_halo2 <- ggplotly(plot_personnes_chomage_halo, height = 600, width = 1000)
plot_personnes_chomage_halo2 <-layout(plot_personnes_chomage_halo2, legend = list(orientation = "h", y = -0.2))

plot_personnes_chomage_halo2
```
...
plot_part_chomage_halo2 <- ggplotly(plot_part_chomage_halo, height = 600, width = 1000)
plot_part_chomage_halo2 <-layout(plot_part_chomage_halo2, legend = list(orientation = "h", y = -0.2))

plot_part_chomage_halo2
```
...
plot_personnes_halo2 <- ggplotly(plot_personnes_halo, height = 600, width = 1000)
plot_personnes_halo2 <-layout(plot_personnes_halo2, legend = list(orientation = "h", y = -0.2))

plot_personnes_halo2
```
...
plot_personnes_ssemploi2 <- ggplotly(plot_personnes_ssemploi, height = 600, width = 1000)
plot_personnes_ssemploi2 <-layout(plot_personnes_ssemploi2, legend = list(orientation = "h", y = -0.2))

plot_personnes_ssemploi2
```
...
plot_full_personnes_besoin_emploi2 <- ggplotly(plot_full_personnes_besoin_emploi, height = 600, width = 1000)
plot_full_personnes_besoin_emploi2 <-layout(plot_full_personnes_besoin_emploi2, legend = list(orientation = "h", y = -0.2))

plot_full_personnes_besoin_emploi2
